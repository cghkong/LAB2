...
public class ConcreteEdgesGraph<L> implements Graph<L> {
    //vertices is the set of vertex
	// edges is the set of edge,the weight > 0
    ...
    // TODO checkRep
    // checke the vertex and edge is not null
    ...
    // return the source of the target with a Map, Integer is the weight 
...
class Edge<L> {
    ...
    //judge whether it is the same edge
